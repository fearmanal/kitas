  ...
  <div class="box-header">
    ...
    <div class="col-md-2 add-button" style="padding: 0;">
        ...
        <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
          <button class="grid-nav btn btn-primary" data-toggle="modal" data-target="#tambah-software"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Add New</button>        
        <?php } ?>
    </div>
    <!--    
    <div class="col-md-3">
...
<!-- Start Mobile Mode -->
<?php foreach ($dataSoftware as $software) { ?>
        <div class="card-post">
          <div class="row">
            <div class="post-content col-xs-12">
              <div class="post-title"><?php echo $software->name; ?></div>
              <div class="post-subtitle"><i><?php echo $software->manufacturer; ?></i></div>
              <div class="post-text">
                  License Quantity : <?php echo $software->license_qty; ?><br/>
                  License Start Date : <?php echo $software->license_start_date; ?><br/>
                  License End Date : <?php echo $software->license_end_date; ?><br/>
              </div>
  ...
  <div class="floater fab-mobile">
    <ul class="floater__list">
      <li class="floater__list-item">
          <a href="<?php echo base_url('software/export/category/'.@$devcat); ?>" class="fab-child"><i class="glyphicon glyphicon glyphicon-floppy-save"></i></a>
          <div class="floater__list-item-label">Export Excel</div>
      </li>
      <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
        <li class="floater__list-item">
            <a href="#" data-toggle="modal" data-target="#tambah-software" class="fab-child"><i class="fa fa-pencil-square-o"></i></a>
