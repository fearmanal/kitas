    ...
    <tr>
      ...
      <td class="text-center">
        <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
                <button class="btn btn-warning update-dataDevices" data-id="<?php echo $devices->id_hardware; ?>"><i class="fa fa-pencil"></i></button>
        ...
        <?php } else if($userdata->role == 'guest') { ?>
                <button class="btn btn-warning update-dataDevices" data-id="<?php echo $devices->id_hardware; ?>"><i class="fa fa-external-link"></i></button>
        <?php } ?>
      </td>
    </tr>
    <?php
