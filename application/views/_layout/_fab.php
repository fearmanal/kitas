<div class="floater">
    <ul class="floater__list">
      <li class="floater__list-item">      
          ...
          <div class="floater__list-item-label">
            <a href="<?php echo base_url('Pegawai'); ?>">Server</a>
            <a href="<?php echo base_url('Posisi'); ?>">Laptop / PC</a>
            <a href="<?php echo base_url('Posisi'); ?>">Monitor</a>
            <a href="<?php echo base_url('Posisi'); ?>">Network Devices</a>
            <a href="<?php echo base_url('Posisi'); ?>">Accessories</a>
            <a href="<?php echo base_url('Posisi'); ?>">Tools</a>
          </div>      
      ...
      <li class="floater__list-item">
          ...
          <div class="floater__list-item-label">
            <a href="<?php echo base_url('Posisi'); ?>">Software</a>
          </div>
      </li>
      <li class="floater__list-item">
          <i class="fa fa-users"></i>
          <div class="floater__list-item-label">
            <a href="<?php echo base_url('Kota'); ?>">Staff</a>
          </div>
      </li>
      <li class="floater__list-item">
          <i class="fa fa-sitemap"></i>
          <div class="floater__list-item-label">
            <a href="<?php echo base_url('Posisi'); ?>">Setup</a>
          </div>
      </li>
      <li class="floater__list-item">
          <i class="fa fa-truck"></i>
          <div class="floater__list-item-label">
            <a href="<?php echo base_url('Kota'); ?>">Supplier</a>
          </div>
      </li>
    </ul>
