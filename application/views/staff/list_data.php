  ...
  foreach ($dataStaff as $staff) {
    ...
    <tr>
      ...
      <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
        <button class="btn btn-primary update-dataStaff" data-id="<?php echo $staff->id_staff; ?>"><i class="fa fa-pencil"></i></button>
      ...
      <?php } else if($userdata->role == 'guest') { ?>
        <button class="btn btn-primary update-dataStaff" data-id="<?php echo $staff->id_staff; ?>"><i class="fa fa-external-link"></i></button>
      <?php } ?>
      </td>
    </tr>
    <?php
