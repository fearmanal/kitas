  ...
  foreach ($dataUsers as $users) {
    ...
    <tr>
      ...
      <?php if($userdata->role == 'administrator') { ?>
        <button class="btn btn-warning update-dataUsers" data-id="<?php echo $users->id; ?>"><i class="fa fa-pencil"></i></button>
        <button class="btn btn-warning resetpass-dataUsers" data-id="<?php echo $users->id; ?>"><i class="fa fa-key"></i></button>
