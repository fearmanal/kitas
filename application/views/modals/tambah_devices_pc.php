  ...
  <div class="misc-form">
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="CPU" name="cpu" aria-describedby="sizing-addon2">
      </div>
    </div>
    <div class="no-pad-right col-md-6">  
      <div class="form-group">
        <label for="memory">Memory</label>
        <input type="text" class="form-control" placeholder="Memory" name="memory" aria-describedby="sizing-addon2">
      </div>
    </div>
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="vga">VGA</label>
        <input type="text" class="form-control" placeholder="VGA" name="vga" aria-describedby="sizing-addon2">
      </div>
    </div>
    <div class="no-pad-right col-md-6">
      <div class="form-group">
        <label for="storage">Storage</label>
        <input type="text" class="form-control" placeholder="Storage" name="storage" aria-describedby="sizing-addon2">
      </div>
    </div>
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="lan_port">LAN Port</label>
        <input type="text" class="form-control" placeholder="LAN Port" name="lan_port" aria-describedby="sizing-addon2">
      </div>
    </div>
    <div class="no-pad-right col-md-6">
      <div class="form-group">
