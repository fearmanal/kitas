  ...
  <div class="misc-form">
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="CPU" name="cpu" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->cpu; ?>">
      </div>
    </div>
    <div class="no-pad-right col-md-6">  
      <div class="form-group">
        <label for="memory">Memory</label>
        <input type="text" class="form-control" placeholder="Memory" name="memory" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->memory; ?>">
      </div>
    </div>
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="vga">VGA</label>
        <input type="text" class="form-control" placeholder="VGA" name="vga" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->vga; ?>">
      </div>
    </div>
    <div class="no-pad-right col-md-6">
      <div class="form-group">
        <label for="storage">Storage</label>
        <input type="text" class="form-control" placeholder="Storage" name="storage" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->storage; ?>">
      </div>
    </div>
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="lan_port">LAN Port</label>
        <input type="text" class="form-control" placeholder="LAN Port" name="lan_port" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->lan_port; ?>">
      </div>
    </div>
    <div class="no-pad-right col-md-6">
      <div class="form-group">
        <label for="wireless_adapter">Wireless Adapter</label>
        <select class="form-control" name="wireless_adapter" aria-describedby="sizing-addon2">
          <option value="Yes" <?php if ($dataDevices->wireless_adapter == 'Yes') echo "selected"; ?>>Yes</option>
          <option value="No" <?php if ($dataDevices->wireless_adapter == 'No') echo "selected"; ?>>No</option>
        </select>
      </div>
    </div>
  </div>
...
<div class="general-form">
  ...
  <div class="misc-form">
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="cpu">CPU</label>
        <input disabled style="cursor: default;" type="text" class="form-control" placeholder="CPU" name="cpu" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->cpu; ?>">
      </div>
    </div>
    <div class="no-pad-right col-md-6">  
      <div class="form-group">
        <label for="memory">Memory</label>
        <input disabled style="cursor: default;" type="text" class="form-control" placeholder="Memory" name="memory" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->memory; ?>">
      </div>
    </div>
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="vga">VGA</label>
        <input disabled style="cursor: default;" type="text" class="form-control" placeholder="VGA" name="vga" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->vga; ?>">
      </div>
    </div>
    <div class="no-pad-right col-md-6">
      <div class="form-group">
        <label for="storage">Storage</label>
        <input disabled style="cursor: default;" type="text" class="form-control" placeholder="Storage" name="storage" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->storage; ?>">
      </div>
    </div>
    <div class="no-pad-left col-md-6">
      <div class="form-group">
        <label for="lan_port">LAN Port</label>
        <input disabled style="cursor: default;" type="text" class="form-control" placeholder="LAN Port" name="lan_port" aria-describedby="sizing-addon2" value="<?php echo $dataDevices->lan_port; ?>">
      </div>
    </div>
    <div class="no-pad-right col-md-6">
      <div class="form-group">
        <label for="wireless_adapter">Wireless Adapter</label>
        <select disabled style="cursor: default;" class="form-control" name="wireless_adapter" aria-describedby="sizing-addon2">
          <option value="Yes" <?php if ($dataDevices->wireless_adapter == 'Yes') echo "selected"; ?>>Yes</option>
          <option value="No" <?php if ($dataDevices->wireless_adapter == 'No') echo "selected"; ?>>No</option>
        </select>
      </div>
