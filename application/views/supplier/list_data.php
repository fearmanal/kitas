  ...
  foreach ($dataSupplier as $supplier) {
    ...
    <tr>
      ...
      <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
        <button class="btn btn-warning update-dataSupplier" data-id="<?php echo $supplier->id_supplier; ?>"><i class="fa fa-pencil"></i></button>
      ...
      <?php } else if($userdata->role == 'guest') { ?>
        <button class="btn btn-warning update-dataSupplier" data-id="<?php echo $supplier->id_supplier; ?>"><i class="fa fa-external-link"></i></button>        
      <?php } ?>
      </td>
    </tr>
    <?php
