  ...
  <div class="box-header">
    ...
    <div class="col-md-2 add-button" style="padding: 0;">
        ...
        <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
          <button class="grid-nav l btn btn-primary" data-toggle="modal" data-target="#tambah-supplier"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Add New</button>
        <?php } ?>
    </div>
    <!--
    <div class="col-md-3">
        ...
        <div class="card-post">
          <div class="row">
            <div class="post-content col-xs-12">
              <div class="post-title"><?php echo $supplier->name; ?></div>
              <div class="post-subtitle"><i><?php echo $supplier->city.', '.$supplier->country; ?></i></div>
              <div class="post-text">
                  Email : <?php echo $supplier->email; ?><br/>
                  Phone : <?php echo $supplier->phone; ?><br/>
                  Fax : <?php echo $supplier->fax; ?><br/>
              </div>
  ...
  <div class="floater fab-mobile">
    <ul class="floater__list">
      <li class="floater__list-item">
          <a href="<?php echo base_url('supplier/export/category/'.@$devcat); ?>" class="fab-child"><i class="glyphicon glyphicon glyphicon-floppy-save"></i></a>
          <div class="floater__list-item-label">Export Excel</div>
      </li>
      <?php if($userdata->role == 'administrator' || $userdata->role == 'management') { ?>
        <li class="floater__list-item">
            <a href="#" data-toggle="modal" data-target="#tambah-supplier" class="fab-child"><i class="fa fa-pencil-square-o"></i></a>
